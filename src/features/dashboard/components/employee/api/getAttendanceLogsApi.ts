...
export async function getAttendanceLogsApi(page: number, limit: number): Promise<AttendanceLogsResponse> {
    const endpoint = `/attendance-logs?page=${page}&limit=${limit}`;
